...
import com.google.fusiontables.ftclient.ClientLogin.LoginCallback;
...
public class FusionTablesDemoActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Initialize FTClient
		final TextView helloTextView = ((TextView) findViewById(R.id.main_hello_text_view));
		helloString = helloTextView
				.getText().toString();
		helloTextView.setText("Authenticating..." );
		
		LoginCallback callback = new LoginCallback() {
			
			@Override
			public void onFinish(String result) {
				//After authenticating, set up FtClient
				helloTextView.setText(helloString);
				String token = result;
		...
		new ClientLogin(callback).execute(username, password);
		initSpinner();
		initButton();
		initLocation();
	}
